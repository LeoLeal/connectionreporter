...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','br.com.leoleal.connectionreporter.js')
...
""" % module_assets
	...
	assets_router = os.path.join(cwd,'Classes','BrComLeolealConnectionreporterModuleAssets.m')
